...
const corsMiddleware = (request: Request, response: Response, next: NextFunction): void => {
  ...
  response.set('Access-Control-Allow-Headers', 'Content-Type, Accept, Accept-Encoding, Accept-Language, X-Access-Token, X-Key, Authorization, X-request-Id, Prefer, X-Logged-Area');
